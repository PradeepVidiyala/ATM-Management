...
int pin,i;
int balance[5];
double accounts[5][2]={998877665544,7799,1,9999,779924490800,1011,986681617600,2580,4444000088880000,1234};
class ATM
{
...
int main()
{
    ...
    cout<<"***********WELCOME***********"<<endl;
    cout<<"*************TO**************"<<endl;
    cout<<"*********TRICHY ATM**********"<<endl;
    cout<<"_____________________________"<<endl<<endl;
    while(1)
    {
    cout
    <<"enter your account number :- "<<endl<<endl;
    cin>>accnumber;
    cout<<endl;
    cout<<"enter pin :-"<<endl;
    cin>>pin;
